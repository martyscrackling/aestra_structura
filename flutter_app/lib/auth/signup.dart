      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(colors: [Color(0xFFFF6B2C), Color(0xFFFF8C5A)]),
            boxShadow: [
              BoxShadow(
        ...
        Row(
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: const Text(
                "Log In",
                style: TextStyle(fontSize: 14, color: Color(0xFFFF6B2C), fontWeight: FontWeight.w600),
              ),
            ),
          ],
        ),
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(icon, color: const Color(0xFF0C1C4D).withOpacity(0.6)),
          suffixIcon: suffixIcon,
          filled: true,
          fillColor: Colors.white,
          border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: Colors.grey[300]!)),
          enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: Colors.grey[300]!)),
          focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFFF6B2C), width: 2)),
