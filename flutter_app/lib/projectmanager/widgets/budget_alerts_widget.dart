...
class _BudgetAlertsWidgetState extends State<BudgetAlertsWidget> {
  ...
  Widget build(BuildContext context) {
      ...
      return _shell(
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                'Could not load budget alerts: $_error',
    ...
    // If the PM has not set any project budgets yet, don't clutter the
    // dashboard with an empty alerts card.
    if (!_anyBudgetConfigured) {
