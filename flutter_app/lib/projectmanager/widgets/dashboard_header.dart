...
class DashboardHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final horizontalPadding = isExtraSmallPhone ? 8.0 : isSmallPhone ? 12.0 : isMobile ? 16.0 : isTablet ? 20.0 : 24.0;
    final verticalPadding = isExtraSmallPhone ? 8.0 : isSmallPhone ? 10.0 : isMobile ? 12.0 : 16.0;
    final titleSize = isExtraSmallPhone ? 14.0 : isSmallPhone ? 16.0 : isMobile ? 18.0 : isTablet ? 22.0 : 24.0;
    final spacing = isExtraSmallPhone ? 4.0 : isSmallPhone ? 6.0 : isMobile ? 8.0 : 16.0;
